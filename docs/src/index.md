...
> the **11.x** line, pairing with .NET 11 and EF Core 11. The previous line, `10.x`, is serviced in parallel
> until three months after `11.0.0` and has its own copy of this site, and release notes live on the
